  ...
  c = new DrawingFabric.Canvas('annoCanvas');
 ...
 function DrawAnnoCanvas(opt){
	var _width = opt.reWidth*opt.scale, 
	    _height = opt.reHeight*opt.scale,
	    _rotate = opt.rotate; 

	c.addFunctionality(new DrawingFabric.Functionality.scale ({
		width: _width,
		height: _height,
		scale: _scale,
		rotate: _rotate
